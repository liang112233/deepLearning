...
import random
from model import MODELS, encoder, decoder
import datetime
import sys
import os
import time
...
def main():
    ...
    encoder_o = encoder(input_size=inputFeatDim, hidden_size=hidden_size, dropout_ratio=dropout_ratio)
    decoder_o = decoder(hidden_size=hidden_size, output_size=output_dim, vocab_size=output_dim, word_dim=word_dim, dropout_ratio=dropout_ratio)
    model = MODELS(encoder=encoder_o, decoder=decoder_o)

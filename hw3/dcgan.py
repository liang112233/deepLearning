...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if (i % 100 == 0)|(i==782):
            ...
            vutils.save_image(real_cpu.data, '%s/real_samples.png' % ("./dcgan_result/real_result"), normalize = True)
            fake = netG(noise)
            vutils.save_image(fake.data, '%s/fake_samples.png' % ("./dcgan_result/fake_result"), normalize = True)

           # FID.fid("./dcgan_result/real_result","./dcgan_result/fake_result")
